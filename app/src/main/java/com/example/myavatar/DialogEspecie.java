...
public class DialogEspecie extends DialogFragment
{
        ...
        builder.setView(MyView)
                ...
                .setPositiveButton(R.string.btn_aceptar, new DialogInterface.OnClickListener()
                {
                    ...
                    public void onClick(DialogInterface dialog, int which)
                    {
                        ...
                        //hacemos que el dialog no se vaya cuando pulsemos fuera de él
                        DialogProfesion.setCancelable(false);
                        DialogProfesion.show(getFragmentManager(),"Dialogo especie");
                    }
                })
    ...
    public void onAttach(Context context)
    {
        ...
        {
            throw new ClassCastException(context.toString()+" ERROR: debes implementar InterfazNombre!!!.");
        }
    }
}